...
class MobileNet(object):
    ...
    def inference(self, images):
        ...
        outs = ops.conv2d(
            images, cur_out_num, (3, 3), 'conv_s', stride=2, keep_r=self.conf.keep_r,
            train=self.conf.is_train, data_format=self.conf.data_format)
        cur_out_num *= 2
        ...
        outs = self.get_block_func()(# 14 * 14 * 512
            ...
            self.conf.data_format, self.conf.group_num)
        cur_out_num *= 2
        ...
        outs = ops.dw_block(# 7 * 7 * 1024
            ...
            self.conf.use_rev_conv, data_format=self.conf.data_format)
